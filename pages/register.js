...
const Register = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[1024px] overflow-hidden text-left text-6xl text-black font-inter">
      ...
      />
      <div className="absolute top-[230px] left-[444px] w-[632px] flex flex-col items-start justify-start gap-[18px]">
      ...
      <div className="absolute top-[370px] left-[444px] w-[632px] flex flex-col items-start justify-start gap-[18px]">
      ...
      <div className="absolute top-[510px] left-[444px] w-[632px] flex flex-col items-start justify-start gap-[18px]">
      ...
      <div
        className="absolute top-[693px] left-[613px] w-[213px] h-[69px] cursor-pointer text-9xl text-white"
      ...
      <div
        className="absolute top-[826px] left-[725px] [text-decoration:underline] font-medium cursor-pointer"
        onClick={onTextClick}
      >
        ยกเลิก
      </div>
