const QuizOnHome3 = () => {
  return (
    <div className="absolute top-[621px] left-[733px] rounded-30xl [background:linear-gradient(#fffefe,_#fffefe),_#fff] box-border w-[567px] h-[184px] overflow-hidden flex flex-row items-center justify-start pt-7 px-[33px] pb-[27px] gap-[34px] text-left text-6xl text-black font-inter border-[7px] border-solid border-lightpink">
      ...
      <div className="w-[108px] relative h-[129px] overflow-hidden shrink-0 text-xl">
        ...
        <p className="m-0 absolute top-[30px] left-[0px] font-medium inline-block w-[305px] h-[75px]">
          description
        </p>
