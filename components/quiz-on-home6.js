const QuizOnHome6 = () => {
  return (
    <div className="absolute top-[621px] left-[130px] rounded-30xl [background:linear-gradient(#fffefe,_#fffefe),_#fff] box-border w-[567px] h-[184px] overflow-hidden flex flex-row items-center justify-start pt-7 px-[33px] pb-[27px] gap-[34px] text-left text-6xl text-black font-inter border-[7px] border-solid border-lightpink">
